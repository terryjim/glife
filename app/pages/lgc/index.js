...
class Lgc extends React.Component {
  constructor(props){
    super(props);
    this.state = {
        //selectItem:0
    ...
    return (
      <View style={defaultStyles.container}>
        ...
        <View style={{height:44,marginTop:27,marginLeft:18}}>
            <Text style={{fontSize:19,fontWeight:'bold',color:'#4A4A4A'}}>特惠套餐</Text>
        </View>
        <View>
...
const mapStateToProps = (state) => {
  ...
  let CarList = {}
  if(drinkList&&drinkList.serviceid==61){
    CarList=drinkList
  }
  return {CarList,drinkOrder,specprodList,user}
}
Lgc = connect(mapStateToProps)(Lgc)
export default Lgc;
